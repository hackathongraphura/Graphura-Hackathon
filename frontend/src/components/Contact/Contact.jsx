        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-8">
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight text-[#fab031] mb-2">
                Contact Us
              </h1>
              <p className="text-white/80 text-base sm:text-lg max-w-[600px]">
                We are always here to help you with your questions, feedback,
                and project requirements. Whether you are looking for
                professional services, technical support, or business
                collaboration, our team is ready to assist you. Feel free to
                reach out to us anytime — we usually respond within 24 hours
                with clear and helpful solutions tailored to your needs.
              </p>
            </div>

            <div className="w-full md:w-auto md:max-w-[350px] lg:max-w-[440px] rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="https://res.cloudinary.com/drq2a0262/image/upload/f_webp/v1771490495/contact-hero_wruskd"
                alt="contact"
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                Whether you have doubts, partnership ideas, sponsorship
                proposals, or want to launch a hackathon with us — connect
                anytime.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex gap-4 items-start p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  ...
                  <a
                    href="tel:+91-7378021327"
                    className="text-gray-700 hover:text-[#03594E] transition-colors text-base md:text-lg flex-1"
                  >
                    +91-7378021327
                  </a>
                </li>
                ...
                <li className="flex gap-4 items-start p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  ...
                  <div className="flex flex-col gap-1 flex-1">
                    <a
                      href="mailto:Hackthon@graphura.in"
                      className="text-gray-700 hover:text-[#03594E] transition-colors text-base md:text-lg break-all"
                    >
                      join@graphura.in
                    </a>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border-4 border-r-8 border-b-8 border-[#03594E]">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="text-center pt-4">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-[#03594E] to-[#1AB69D] cursor-pointer text-white px-10 py-4 rounded-lg font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 flex items-center gap-2 mx-auto"
                >
                  Send Message
